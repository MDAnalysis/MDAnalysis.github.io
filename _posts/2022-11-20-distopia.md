...
```c++
#include <cmath>
void VanillaCalcDistances(const float *coords1, const float *coords2,
...
vectorised operations to generate highly optimised assembly. This is based on packing the coordinates in each dimension into  
