...
!!! put in example vanilla distance 
...
!!! add class showing distninction with vec3
```c++
...
class fvec4 {
public:
    __m128 val; // holds xyz and one blank coordinate.
    // define all operators and functions

};
```

This also provides some speed improvement. 
