...
<div style="border: 1px solid #F00; padding: 10px; margin: 10px 0;">
    <p>
    <strong>Do not use generative AI</strong> to <strong>develop or write</strong> your pre-proposal. We need to hear <em>your</em> ideas and voice.
	</p>
...
<div style="border: 1px solid #F00; padding: 10px; margin: 10px 0;">
    <p>
    <strong>Do not use generative AI</strong> to <strong>develop or write</strong> your proposal. We need to hear <em>your</em> ideas and voice.
	</p>
	<p><small>You are allowed to use AI tools for grammar and spell checking and for translation into English although we are more than happy to read your proposal in your own English words.</small></p>
</div>
