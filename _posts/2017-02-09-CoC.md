...
[Code of Conduct]({{ site.baseurl }}/conduct) (CoC) to make
...
[http://mdanalysis.org/conduct]({{ site.baseurl }}/pages/conduct/).
...
[communicate safely]({{ site.baseurl }}/conduct#reporting) with a
...
heavily borrowed –
[thank you]({{ site.baseurl }}/conduct#acknowledgment)!).
