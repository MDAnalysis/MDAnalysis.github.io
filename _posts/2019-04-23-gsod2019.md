...
[pydiffusion](https://github.com/bio-phys/pydiffusion) and
[pycontact](https://github.com/maxscheurer/pycontact), or for embedding it
into existing programs, like
[pymol](https://nms.kcl.ac.uk/lorenz.lab/wp/index.php/2019/04/17/mda-pymol/)
--- for more examples see our recent post on [MDAnalysis as a building
block][post-buildingblock].
