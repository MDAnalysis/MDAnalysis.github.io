...
![VACF Plot]({{site.images}}/final_report_xuhong/vacf_plot.png){: width="1280" height="960" }

#### Running Integral Plot

![Running Integral Plot]({{site.images}}/final_report_xuhong/running_integral_plot.PNG){: width="1280" height="960" }
