...
### *Bursaries* for in-person attendance (Now Closed)
...
|-----------|------------------------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------------|
| Morning   | • Welcome<br/>* Introduction to MDAnalysis<br/>• Keynote (*Matthias Heyden*)<br/>• Contributed Talks<br>• Posters | • Keynote (*Lillian Chong*)<br/>• Contributed Talks  | • Workshop Installation Clinic<br/>• Visualization Workshop<br/>• Lightning Talks<br/>• OpenFF Workshop  |
| Afternoon | • MDAnalysis Streaming Workshop                                                                                   | •  Contributed Talks<br/>• Lightning Talks<br/>• Master Classes | • OpenFF Workshop<br/> • OpenFE Workshop<br/>• OpenADMET Workshop  |
...
Reserve your room in the [Hyatt Place Tempe Phoenix University Hotel Block](https://www.hyatt.com/en-US/hotel/arizona/hyatt-place-tempe-phoenix-university/phxzt?corp_id=G-O208) while there are still rooms available! You can reserve between Nov. 8th and Nov. 11th using the provided link or use the group code, G-O208. This hotel is 0.3 mi from the [meeting venue][ASU] and 0.4 mi from the [Light Rail][Light Rail]. Breakfast is included.
...
Physics at [Arizona State University][ASU]. The address is:
...
**IMPORTANT** On the 9th and 11th of November, the workshop will be held in **room PSF 186 in the Physical Sciences F
building**. On the 10th of November **room PSH 350 in the Physical Sciences H building**.
...
[UGM schedule]: https://github.com/MDAnalysis/UGM2025/blob/update_schedule/SCHEDULE.pdf
[UGM 2025 github repository]: https://github.com/MDAnalysis/UGM2025/
