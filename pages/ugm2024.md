...
*Abstract and bursary application deadline: Monday, April 1, 2024*

You may now submit an abstract using the [abstract submission form](https://forms.gle/usXuZVeM1iZiTDZY8) before the deadline of **April 1, 2024**. We welcome abstracts from all areas relevant to MDAnalysis's work, including the use and development of open source software and tools for molecular simulations data analysis. 

We also have a small number of bursaries available to enable underrepresented and early career researchers facing financial barriers to attend and present their work; these can be applied for when submitting your abstract. Abstracts and bursary applications will be reviewed after the April 1st deadline. We will contact applicants shortly after.
