...
## Meals
Food and beverages will be provided where noted on the [agenda](https://www.mdanalysis.org/pages/ugm2024/#program) (i.e., Coffee Break, Lunch, Reception). For mealtimes that are not listed, we encourage you to explore Lisbon to check out England's cuisine options! We have also compiled a few suggestions below.
