...
- NSF CSSI award, 2311372 (**2023—2026**)  [Elements: Streaming Molecular Dynamics Simulation Trajectories for Direct Analysis: Applications to Sub-Picosecond Dynamics in Microsecond Simulations](https://www.nsf.gov/awardsearch/show-award/?AWD_ID=2311372) (@HeydenLabASU (PI), @orbeckst (co-PI),  **MDAnalysis Personnel**: @orbeckst @hmacdope @yuxuanzhuang @jaclark5 )
